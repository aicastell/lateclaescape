...
[Este código fuente](https://github.com/aicastell/ipc/blob/main/mutex/mutex.c) en C utiliza un mutex para evitar la [condición de carrera](/post/2025/race-conditions) descrita en un artículo anterior.
...
[Este código fuente](https://github.com/aicastell/ipc/blob/main/deadlock/deadlock.c) en C ilustra un caso de deadlock entre dos hilos.
...
[Este código fuente](https://github.com/aicastell/ipc/blob/main/deadlock/fix2/deadlock_fix2.c), escrito en C, resuelve el problema del deadlock empleando pthread_mutex_trylock en lugar de pthread_mutex_lock.
